...
import platform.windows.SS_CENTERIMAGE
...
value class Alignment internal constructor(internal val value:Int){
    ...
    val staticStyle:Int get() {
        val h = if (right) SS_RIGHT else if (middleX) SS_CENTER else SS_LEFT
        val v = if(middleY) SS_CENTERIMAGE else 0
        return h or v
    }
}
val A get() = Alignment()
...
fun Alignment.middle() = middleX().middleY()