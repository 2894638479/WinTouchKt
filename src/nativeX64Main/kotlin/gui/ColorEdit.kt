...
fun GuiScope.ColorEdit(modifier: Modifier = M,alignment: Alignment = A,get: MutState<Color>,set:(Color)->Unit){
    ...
    Column(modifier,alignment) {
        ...
        fun GuiScope.Edit(state: MutState<String>, set:(UByte)->Unit) = Edit(
